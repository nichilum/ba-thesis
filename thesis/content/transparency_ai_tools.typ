...
AI tools, namely Microsoft Copilot, OpenAI ChatGPT 5.2 and 5.3-Codex as well as Claude Sonnet 4.6, were utilized in parts for code generation allowing for faster prototyping and analysis of data. These tools additionally provided writing support in the form of synonym suggestion and reformulation of passages. Machine translation of relevant content was performed using DeepL.

All AI-assisted outputs were reviewed and verified by the authors prior to inclusion.
