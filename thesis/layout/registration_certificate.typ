#import "/thesis/utils/formfield.typ": *
...
#let registrationCertificate(
  ...
  grid(
    ...
    formField("Studiengang", program, length: 90%), formField("Titel der Arbeit", title, length: 90%),
  )
  ...
  grid(
    columns: 2,
    column-gutter: 2cm,
    formField("Datum", currentDate.display("[day].[month].[year]"), length: 90%), formField(examiner, " ", length: 90%),
  )
}
