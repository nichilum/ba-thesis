...
Architecturally Quality-Net is based on bidirectional long short-term memory. An improvement to standard @RNN:pl (cf. @fun_rnn) where sequential data is processed in both forward and backward directions using two separate hidden layers (cf. ).
